    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:shefalisawant99@gmail.com" className="p-text">shefalisawant99@gmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="phone" />
          <a href="tel:+91 9172741544" className="p-text">+91 9172741544</a>
        </div>
      </div>
      {!isFormSubmitted ? (
       ...
       <div className="copyright">
          <p className="p-text">@2024 SHEFALI SAWANT</p>
